...
if contribution_margin > 0:
    ...
    # Highlight break-even point with a more opaque dotted line that bends at 90 degrees
    ...
    # Highlight target profit point with a more opaque dotted line that bends at 90 degrees
    ax.axvline(target_volume, color='orange', linestyle='--', alpha=0.6)
    ax.axhline(target_volume * avg_basket_value, color='orange', linestyle='--', alpha=0.6)
    ax.plot([target_volume, target_volume], [0, target_volume * avg_basket_value], linestyle='--', color='orange', alpha=0.6)
...
if contribution_margin > 0:
    ...
    # Highlight the updated target profit point with a dotted vertical line
    ax2.axvline(updated_target_volume, color='orange', linestyle='--', alpha=0.6)
    ax2.axhline(updated_target_volume * avg_basket_value, color='orange', linestyle='--', alpha=0.6)
    ax2.plot([updated_target_volume, updated_target_volume], [0, updated_target_volume * avg_basket_value], linestyle='--', color='orange', alpha=0.6)
